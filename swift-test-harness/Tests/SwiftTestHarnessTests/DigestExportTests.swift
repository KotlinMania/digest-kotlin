...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Digest.swiftmodule/`
...
//      `import Digest` above would fail at compile time.
//
//   2. The static archive `libDigest.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Digest" }` and
...
final class DigestExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Digest swift module imported cleanly")
    }
}
