...
kotlin {
    ...
    val xcf = XCFramework("Digest")

    macosArm64 {
        binaries.framework { baseName = "Digest"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Digest"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Digest"
        flattenPackage = "io.github.kotlinmania.digest"
    }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "digest-kotlin", version.toString())

    pom {
        name.set("digest-kotlin")
        description.set("Kotlin Multiplatform port of RustCrypto/traits - Traits for cryptographic hash functions and message authentication codes")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/digest-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/digest-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/digest-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/digest-kotlin.git")
        }
    }
}
